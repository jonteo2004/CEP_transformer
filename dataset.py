...
def tokenize_and_filter(hparams, tokenizer, questions, answers):
    ...
    # pad tokenized sentences so all same length
...
def get_dataset(hparams):
    ...
    # tensorflow dataset nicely has a feature for building out of these corpus
    ...
    # making our lists into tf.data.Dataset so our model can read it
